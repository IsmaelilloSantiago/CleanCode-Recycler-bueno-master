...
import es.ulpgc.eite.cleancode.visitcanary.cover.CoverState;
...
public class CatalogMediator  {
  ...
  private CoverState coverState=new CoverState();
  ...
  public CoverState getCoverState(){ return coverState;}
